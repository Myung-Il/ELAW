// 커리큘럼 현황 페이지
// 추천 공부 목록, 총 학습량, 기업 합격자 비교 데이터를 한눈에 표시
"use client"
...
//   Response: { weeks: [...], stats: { total, solved, ... }, comparison: [...] }
// [DB 매뉴얼] CurriculumWeeks + UserProgress 테이블 JOIN하여 완료 여부 계산
const curriculum = [
...
// 기업 합격자 비교 데이터
// [BE 매뉴얼] GET /api/v1/curriculum/comparison?company_id=1 → 합격자 통계 반환
// [DB 매뉴얼] CompanyPassStats 테이블: company_id, topic, avg_proficiency
const comparison = [
      ...
      <main className="container mx-auto px-4 lg:px-8 py-8 max-w-6xl">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="space-y-5">
            ...
            {/* 합격자 비교 */}
            {/* [FE 수정 매뉴얼] comparison 배열을 GET /api/v1/curriculum/comparison API로 교체 */}
            <Card className="shadow-sm">
              <CardHeader className="pb-3">
                <CardTitle className="text-sm flex items-center gap-2">
